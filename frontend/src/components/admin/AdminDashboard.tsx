  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "stripe_product_id", label: t("fieldLabels", "stripe_product_id"), type: "text", nullable: true },
        { name: "stripe_price_id", label: t("fieldLabels", "stripe_price_id"), type: "text", nullable: true },
